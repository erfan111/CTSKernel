...
OBJS += \
./tools/usb/ffs-aio-example/multibuff/host_app/test.o 

C_DEPS += \
./tools/usb/ffs-aio-example/multibuff/host_app/test.d 


# Each subdirectory must supply rules for building sources it contributes
tools/usb/ffs-aio-example/multibuff/host_app/%.o: ../tools/usb/ffs-aio-example/multibuff/host_app/%.c
	@echo 'Building file: $<'
